...
- [AI Workflow Mainline](00_CONCEPT/AI_WORKFLOW_MAINLINE.md)
- [Demand to Loop Compiler](00_CONCEPT/DEMAND_TO_LOOP_COMPILER.md)
- [Loop Engineering Theory](00_CONCEPT/LOOP_ENGINEERING_THEORY.md)

## Protocol

- [Loop Spec](01_PROTOCOL/LOOP_SPEC.md)
- [Stop Gate Spec](01_PROTOCOL/STOP_GATE_SPEC.md)
- [Work Order Spec](01_PROTOCOL/WORK_ORDER_SPEC.md)
- [Verifier Spec](01_PROTOCOL/VERIFIER_SPEC.md)
- [Handoff Spec](01_PROTOCOL/HANDOFF_SPEC.md)

## Templates

- [TARGET](02_TEMPLATES/TARGET.template.md)
- [PATH](02_TEMPLATES/PATH.template.md)
- [ACCEPTANCE](02_TEMPLATES/ACCEPTANCE.template.md)
- [STATE](02_TEMPLATES/STATE.template.md)
- [LOOP_LOG](02_TEMPLATES/LOOP_LOG.template.md)
- [STOP_GATE](02_TEMPLATES/STOP_GATE.template.md)
- [HANDOFF](02_TEMPLATES/HANDOFF.template.md)
- [WORK_ORDER](02_TEMPLATES/WORK_ORDER.template.md)

## Workflows

- [Bounded Codex Loop](05_WORKFLOWS/BOUNDED_CODEX_LOOP.md)
- [Knowledge Update Loop](05_WORKFLOWS/KNOWLEDGE_UPDATE_LOOP.md)
...
- [Creator Workflow Theory v1](CREATOR_WORKFLOW_THEORY_V1.md)
- [Creator Workflow Operating Model](CREATOR_WORKFLOW_OPERATING_MODEL.md)
- [Creator Workflow Scenarios](CREATOR_WORKFLOW_SCENARIOS.md)
